...
plot2 = plot_type(ells[:], clkappag_ratio[:], linewidth=1, label=r'$\kappa_{gal}~\kappa_{gal}$')
plot2 = plot_type(ells[:], clkappag_kappacmb_ratio[:], linewidth=1, label=r'$\kappa_{gal}~\kappa_{CMB}$')
plot2 = plot_type(ells[:], clkappag_gal_ratio[:], linewidth=1, label=r'$\kappa_{gal}~ g$')
plot2 = plot_type(ells[:], clkappacmb_gal_ratio[:], linewidth=1, label=r'$\kappa_{CMB} ~g$')
plot2 = plot_type(ells[:], clkappa_cmb_ratio[:], linewidth=1, label=r'$\kappa_{CMB}~\kappa_{CMB}$')
plot2 = plot_type(ells[:], clg_lenses_ratio[:], linewidth=1, label=r'$g~g$')
...
# ============================================
plt.savefig('../images/spectra.pdf', dpi=200, papertype='Letter',
